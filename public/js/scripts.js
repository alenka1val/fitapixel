...
function zoomIn(imgName, index, photograph, description, competition, place) {
    ...
    captionText3.innerHTML = place + ". miesto";
...
function moveLeft(photoList) {
    ...
    captionText3.innerHTML = photoList[nextIndex]['place'] + ". miesto";
