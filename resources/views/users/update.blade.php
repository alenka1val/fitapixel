                    ...
                    <div class="form-group">
                        <div>
                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror input"
                                   name="name" value="@if(old('name')){{ old('name') }}@elseif($user->name){{ $user->name }}@endif" required autocomplete="name"
                    ...
                    <div class="form-group">
                        <div>
                            <input id="email" type="email"
                                   ...
                                   value="@if(old('email')){{ old('email') }}@elseif($user->email){{ $user->email }}@endif" required autocomplete="email" placeholder="Email">
                            @error('email')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group">
                        <div>
                            <input id="phone" type="text"
                                   ...
                                   value="@if(old('phone')){{ old('phone') }}@elseif($user->phone){{ $user->phone }}@endif" autocomplete="phone" placeholder="Telefón" autofocus>
                            @error('phone')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group">
                        <div>
                            <input id="web" type="text" class="form-control @error('web') is-invalid @enderror input"
                                   name="web" value="@if(old('web')){{ old('web') }}@elseif($user->web){{ $user->web }}@endif" autocomplete="web" placeholder="Webová stránka"
                                   autofocus>
                            @error('web')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                    ...
                    <div class="form-group">
                        <div>
                            <input id="address_street" type="text"
                                   ...
                                   name="address_street" value="@if(old('address_street')){{ old('address_street') }}@elseif($user->address_street){{ $user->address_street }}@endif"
                    ...
                    <div class="form-group">
                        <div>
                            <input id="address_city" type="address_city"
                                   ...
                                   name="address_city" value="@if(old('phone')){{ old('phone') }}@elseif($user->phone){{ $user->phone }}@endif{{ old('address_city') || $user->address_city }}" autocomplete="address_city"
                    ...
                    <div class="form-group">
                        <div>
                            <input id="address_zip_code" type="text"
                                   ...
                                   name="address_zip_code" value="@if(old('address_zip_code')){{ old('address_zip_code') }}@elseif($user->address_zip_code){{ $user->address_zip_code }}@endif"
                    ...
                    <div id="juryDiv" style="display: none">
                        <div class="form-group">
                            ...
                            <textarea id="description" name="description" class="form-control input"
                                      placeholder="Napíšte nám niečo o sebe" autofocus cols="40" rows="10">{{ $user->description }}</textarea>
                            </div>
                        </div>
                        <label class="file">
                            <p>Pridať fotku</p>
